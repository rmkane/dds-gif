...
public class GifSequenceWriter {
	...
	public GifSequenceWriter(ImageOutputStream outputStream, int imageType, int timeBetweenFramesMS,
			boolean loopContinuously, DisposalMode disposalMode) throws IIOException, IOException {
		...
		graphicsControlExtensionNode.setAttribute("disposalMethod", disposalMode.getDisposalMethod());
	...
	public static void main(String[] args) throws Exception {
		if (args.length > 1) {
			...
			GifSequenceWriter writer = new GifSequenceWriter(output, firstImage.getType(), 1, false, DisposalMode.NONE);
